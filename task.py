...
if (not task or task.type == 'master'):
    out = os.path.join(args.output_path, 'my_model.h5')
    print(out)
    print('save')
    model.save(out)
...
if output_path and (not task or task.type == 'master'):
    print("test")
    print(args.output_path)
    print(output_path)
    subprocess.check_call(['gsutil', '-m', '-q', 'cp', '-r', args.output_path, output_path])
